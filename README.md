...
Using Alpha version of WiFi kexts for Ventura, check here for update since they are pretty often and its useless to update repo every time with one kext or if you're not planning to use Ventura, switch to stable for your macOS version!:
